  ...
  return (
    <div style={{ padding: 18, display: 'flex', gap: 14, flex: 1, minHeight: 0 }}>
      <div style={{
        ...
        <div style={{ fontSize: 11, fontWeight: 600, color: '#9AA1AC', textTransform: 'uppercase', letterSpacing: 0.5, padding: '2px 2px 0' }}>
          Historial
        </div>
          ...
          {conversaciones.map((conv) => (
            <div
              ...
              style={{
                ...
                background: conv.id === conversacionActivaId ? 'rgba(114, 157, 238, 0.12)' : 'transparent',
            ...
            >
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <div style={{ fontSize: 12, color: '#9AA1AC', fontVariantNumeric: 'tabular-nums' }}>{fechaRelativa(conv.updated_at)}</div>
              </div>
              <button
                onClick={(e) => eliminarConversacion(conv.id, e)}
                title="Eliminar conversación"
                style={{
                  border: 'none', background: 'none', cursor: 'pointer', color: '#9AA1AC',
      ...
      <div style={{
        ...
        <div style={{ padding: '14px 18px', borderBottom: `1px solid ${BD}`, display: 'flex', alignItems: 'center', gap: 12 }}>
          <div style={{ width: 36, height: 36, borderRadius: '10px', background: 'rgba(114, 157, 238, 0.12)', color: P, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
