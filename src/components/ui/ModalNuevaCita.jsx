...
export default function ModalNuevaCita({ onClose, onSave, listaPacientes, modo = 'cita' }) {
  ...
  return (
    <Modal cardStyle={{ padding: 25, width: 420, boxShadow: '0 10px 25px rgba(0,0,0,0.1)' }}>
        ...
        <div style={{ display: 'flex', gap: 10, marginTop: 25 }}>
          <Button variant="secondary" onClick={onClose} style={{ flex: 1, padding: 12, fontSize: 14 }}>Cancelar</Button>
          <Button onClick={onSubmit} style={{ flex: 1, padding: 12, fontSize: 14, background: '#0D5C6B' }}>
