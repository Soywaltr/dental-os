  ...
  return (
    ...
    <div onClick={onClick} style={{
      ...
      {/* La cifra va en tinta neutra; el color vive en el ícono y en la
          ...
          arcoíris. */}
      <div style={{ fontSize: 11, color: '#9AA1AC', marginBottom: 5, fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.4px' }}>{label}</div>
      <div style={{ fontSize: 28, fontWeight: 700, letterSpacing: '-0.02em', color: '#0A0A0A', lineHeight: 1.1, fontVariantNumeric: 'tabular-nums' }}>{value}</div>
