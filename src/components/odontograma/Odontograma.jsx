      ...
      {sel && (
        <div style={{ width: 250, background: '#fff', borderLeft: `1px solid ${BD}`, overflowY: 'auto', flexShrink: 0, padding: 16 }}>
          ...
          <div style={{ display: 'flex', gap: 6, marginBottom: 15 }}>
            ...
            <button onClick={() => setCurrentTeeth(p => { const next = {...p}; if(next[sel]) delete next[sel]; return next; })} style={{ background: '#fef2f2', color: RJ, border: `1px solid ${RJ}44`, borderRadius: 8, padding: '8px 12px', fontSize: 12, fontWeight: 800, cursor: 'pointer' }}>↺</button>
          </div>
